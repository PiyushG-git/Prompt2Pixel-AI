...
const Login = () => {
  ...
  return (
    <motiodiv className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'
    ...
    >  
      <motion.form className='relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <p className='mt-5 text-center'>
            Already have a account? <span className='text-blue-600 cursor-pointer' onClick={()=>setState('Login')}>Login</span>
        </p>}
